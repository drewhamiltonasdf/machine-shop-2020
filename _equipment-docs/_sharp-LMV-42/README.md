...
For more, check out the following YouTubers to go deep:
  * ![  -MIT Machine Shop Courses](https://img.youtube.com/vi/4McYKCd2Hg&list=PLG8tVvd9GeWkFVcim_m5NUGLcwQ_BaXMZ/0.jpg)]
a  * ![  -Blondihacks](https://img.youtube.com/vi/4McYKCd2Hg&list=PLG8tVvd9GeWkFVcim_m5NUGLcwQ_BaXMZ/0.jpg)](https://www.youtube.com/watch?v=0MDFxGE4SzY "Everything Is AWESOME")
  ...
  * ![  Stefan Gotteswinter](https://www.youtube.com/watch?v=t2Y6xR7iCto "Everything Is AWESOME")
...
### Lubrication
 ...
 - The Spindle should be oiled with every use of the machine to keep it in the immaculate condition that it is currently in. Use <b>Mobil Velocite No. 10</b>, the recommended light duty 
   spindle oil for milling machines, and nothing else! When it comes to Spindle Oil, oils are NOT interchangeable.
 
 - Way oil: (<b>Vactra No. 2</b>) is for the ways only. This can be added to the automatic way oiler when running low.
